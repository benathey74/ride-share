    ...
    <Card className="rounded-3xl border-primary/25 bg-primary/[0.06]">
      <CardHeader className="flex flex-row items-start gap-3 space-y-0 pb-2">
        ...
        <div className="min-w-0 space-y-1">
          <CardTitle className="text-base">Set up driver profile first</CardTitle>
          <CardDescription className="text-left text-sm leading-relaxed">
            The driver dashboard and routes are only available after you submit vehicle details and
            (for most workspaces) get approved. Continue below, or stay on Home to ride as a
            passenger.
          </CardDescription>
        </div>
      </CardHeader>
      <CardContent className="flex flex-col gap-2 pt-0 sm:flex-row">
        <Button asChild className="rounded-2xl">
          <Link href={ROUTES.onboarding.driver}>Add driver details</Link>
        </Button>
