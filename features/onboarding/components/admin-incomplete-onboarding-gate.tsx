...
/**
 * Admin shell: require API + readable onboarding snapshot + `onboardingCompletedAt`.
 * Role/API authorization stays on admin pages; this only blocks incomplete or unusable workspace state.
 */
export function AdminIncompleteOnboardingGate({ children }: { children: ReactNode }) {
